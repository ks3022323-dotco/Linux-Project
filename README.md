# Linux-Project
# oss-audit-24BCE10417

**Open Source Software Audit — VITyarthi**

| Field | Details |
|---|---|
| **Student Name** | Kumkum Singh|
| **Roll Number** | 24BCE10417 |
...
```bash
git clone https://github.com/kumkum-24-dot/oss-audit-24BCE10417.git
cd oss-audit-24BCE10417
```
